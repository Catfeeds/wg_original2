...
$(document).on('click', '#myInfo_page', function() {
	$.showPreloader();
	$.getJSON('http://127.0.0.1/wg_original2/index.php?g=Wap&m=Distribution&a=myInfo', function(json, textStatus) {
