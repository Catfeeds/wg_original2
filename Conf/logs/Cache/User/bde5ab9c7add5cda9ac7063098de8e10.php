...
<a href="<?php echo U('Store/addDisplay', array('token' => $token,'cid'=>$_GET['cid']));?>" title="新增分类" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" class="vm">新增展示
</a>
...
<div class="pageNavigator left"> 
<a href="<?php echo U('Store/addDisplay', array('token' => $token));?>" title="新增分类" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" class="vm">新增展示
</a>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
</div>
...
基本价格：￥<?php echo ($hostlist["price1"]); ?><br/>

加修加印：￥<?php echo ($hostlist["price2"]); ?><br/>

加印　　：￥<?php echo ($hostlist["price3"]); ?>


</td>

<<<<<<< HEAD
<td><?php echo ($hostlist["name1"]); ?></td>

<td><img style="width: 200px;" src="<?php echo ($hostlist["logo"]); ?>" alt="封面图片"></td>


<td class="norightborder">
	<a href="<?php echo U('Store/picEdit',array('token'=>$token,'id'=>$hostlist['id'],'cid'=>$_GET['cid']));?>">修改</a>
=======
<td><img style="width: 200px;" src="<?php echo ($hostlist["logo"]); ?>" alt="封面图片"></td>

<td class="norightborder">
	<a href="<?php echo U('Store/picEdit',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>

>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2

<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/delDisplay', array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
