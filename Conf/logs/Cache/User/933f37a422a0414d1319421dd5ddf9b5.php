...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4>展示分类设置</h4> 
    <a href="<?php echo U('Store/showClass',array('token'=>$token,'parentid'=>$_GET['parentid']));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       ...
       <tr> 
        <th><span class="red">*</span>展示名称：</th> 
        <td><input type="text" name="name" value="<?php echo ($set["name"]); ?>" class="px" style="width:400px;" />
          <input type="hidden" name="id" value="<?php echo ($set["id"]); ?>">
        </td> 
       </tr> 
       ...
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Store/showClass',array('token'=>$token,'cid'=>$_GET['cid']));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
