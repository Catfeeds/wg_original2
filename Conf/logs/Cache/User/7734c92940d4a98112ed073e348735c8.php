...
<script type="text/javascript" src="<?php echo RES;?>/diyUpload/js/diyUpload.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4>展示页设置</h4> 
    <a href="<?php echo U('Store/picDisplay',array('token'=>$token,'cid'=>$classify['id']));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
      ...
      <tbody> 
        ...
        <td>
          <select name="cid" id="cid">
           <option value="<?php echo ($classify["id"]); ?>" selected="selected"><?php echo ($classify["name"]); ?></option>
          </select>
        </td> 
       </tr> 
       <tr> 
