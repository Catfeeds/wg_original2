...
<a href="<?php echo U('Store/addCoupon');?>" title="" class="btnGrayS vm bigbtn">批量生成优惠券</a>
</div>
<div class="clr"></div>
</div>
...
<td><?php echo (date("Y-m-d",$o["endtime"])); ?></td>
<td><?php echo ($o["limitprice"]); ?></td>
<td>

<?php switch($o["status"]): case "0": ?>未领取<?php break;?>
	<?php case "1": ?>已领取<?php break;?>	
	<?php case "2": ?>已过期<?php break;?>
	<?php case "3": ?>已使用<?php break; endswitch;?>

</td>

<td>
	<?php echo (($o["account"]["username"])?($o["account"]["username"]):"还未领取"); ?>

</td>

<td class="norightborder">
<!-- <a href="<?php echo U('Store/editCoupon',array('token'=>$token,'id'=>$o['id']));?>">查看优惠券</a> -->&nbsp;&nbsp;
<?php if($o["status"] == 0): ?><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/delCoupon',array('token'=>$token,'id'=>$o['id'],'dining'=>$isDining));?>');">删除</a><?php endif; ?>
