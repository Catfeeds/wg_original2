...
<li class="city" id="tab2"><a href="<?php echo U('Shop/index',array('token'=>$token));?>">城市管理</a></li>
<<<<<<< HEAD
<li class="current city" id="tab2"><a href="<?php echo U('Shop/departList',array('token'=>$token));?>">分店管理</a></li>
=======
<li class="current city" id="tab2"><a href="<?php echo U('Store/departList',array('token'=>$token));?>">分店管理</a></li>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
...
<<<<<<< HEAD
<a href="<?php echo U('Shop/departAdd', array('token' => $token, 'cid' => $_GET['cid']));?>" title="添加" class="btnGrayS vm bigbtn">
=======
<a href="<?php echo U('Shop/departAdd', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加店铺</a>


</div>

<div style="text-align: center; font-size: 15px" float="left">
	<span>
              <form action="" method="post">
              店铺关键词：
              <input type="text" name="searchkey" class="px" value="<?php echo ($_REQUEST['searchkey']); ?>" style="width: 200px;">
              <input type="submit" class="btnGrayS" value="搜索"style="font-size: 15px !important;
...
<td hidden><?php echo ($hostlist["id"]); ?></td>
<td><?php echo ($hostlist["name"]); ?></td>
<td><?php echo ($hostlist["tele"]); ?></td>
<td><?php echo ($hostlist["address"]); ?></td>
<td><?php echo ($hostlist["username"]); ?></td>
<td><?php echo ($hostlist["longitude"]); ?></td>
<td><?php echo ($hostlist["dimension"]); ?></td>

<<<<<<< HEAD
<td class="norightborder">
	<a href="<?php echo U('Shop/departSet',array('token'=>$token,'sid'=>$hostlist['id'],'cid'=>$_GET['cid']));?>">修改</a>
  <a href="<?php echo U('Shop/schedule',array('token'=>$token,'sid'=>$hostlist['id'],'name'=>$hostlist['name'],));?>">附加</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Shop/departDel',array('id'=>$hostlist['id'],'cid'=>$_GET['cid'],'token'=>$token));?>');">删除</a>
=======

<td class="norightborder">
	<a href="<?php echo U('Shop/departSet',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>
  <a href="<?php echo U('Shop/schedule',array('token'=>$token,'id'=>$hostlist['id'],'name'=>$hostlist['name']));?>">附加</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Shop/departDel',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
</td>
