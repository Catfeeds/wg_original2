...
<li class="current city" id="tab2"><a href="<?php echo U('Shop/index',array('token'=>$token));?>">城市管理</a></li>
<li class="city" id="tab2"><a href="<?php echo U('Shop/departList',array('token'=>$token));?>">分店管理</a></li>
...
<a href="<?php echo U('Shop/cityAdd', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加城市</a>
...
<td><?php echo ($hostlist["char"]); ?></td>
<td><?php echo ($hostlist["snums"]); ?></td>
<<<<<<< HEAD
<td><?php echo ($hostlist["hot"]); ?></td>
<td class="norightborder">
  <a href="<?php echo U('Shop/departList',array('token'=>$token,'id'=>$hostlist['id']));?>">分店列表</a>
=======
<td class="norightborder">
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
	<a href="<?php echo U('Shop/citySet',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/cityDel',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
</td>
