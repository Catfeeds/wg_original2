...
<div class="content">
        ...
        　　      <span>
                    ...
                    关键词：
                    <input type="text" name="keyword" class="px" value="<?php echo ($_REQUEST['name']); ?>" placeholder="关键词">
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td class="norightborder">
                    <a href="<?php echo U('Distribution/accountDetail',array('id'=>$list['id'],'type'=>'detail','p'=>$_GET['p']));?>" title="详细">详细</a> 
