    ...
    <div class="msgWrap bgfc">
      <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          ...
          <td>
            <select name="sid" id="">
              <?php if(is_array($stores)): $i = 0; $__LIST__ = $stores;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </td>
        </tr>
          <tr>
            <th>时间选择:</th>
            <td>
              <input class="Wdate" id="starttime" name="limittime" value="<?php echo ($set["time"]); ?>" type="text" onClick="WdatePicker()" style="width:190px">
            </td>
          </tr>
         ...
         .w15{
          ...
          <td>
            ...
            &nbsp;
            <a href="<?php echo U('Store/departList',array('token'=>$token));?>" class="btnGray vm">取消</a>
          </td>
        </tbody>
      </table>
    </div>
