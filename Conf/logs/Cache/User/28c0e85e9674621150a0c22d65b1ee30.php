...
<li class="tabli" id="tab2"><a href="<?php echo U('Store/guanggao',array('token'=>$token));?>">会员等级管理</a></li>
<li class="city" id="tab2"><a href="<?php echo U('Store/cityList',array('token'=>$token));?>">城市管理</a></li>
...
<a href="<?php echo U('Store/departAdd', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
...
<td class="norightborder">
	<a href="<?php echo U('Store/departSet',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/departDel',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
</td>
