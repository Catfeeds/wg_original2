...
<script src="<?php echo STATICS;?>/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4>城市设置</h4> 
    <a href="<?php echo U('Store/cityList',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input hidden type="text" name="id" value="<?php echo ($set["id"]); ?>" class="px" style="width:120px;" /></td> 
       </tr> 
       ...
       <tr> 
        ...
        <td><input type="text" name="name" value="<?php echo ($set["name"]); ?>" class="px" style="width:120px;" /></td> 
	     ...
	     <tr> 
        <th>首字母：</th> 
        <td><input type="text" name="char" value="<?php echo ($set["char"]); ?>" class="px" style="width:120px;" /></td> 
       </tr>
       <th>&nbsp;</th>
       <td>
       <button type="submit"  class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Shop/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
