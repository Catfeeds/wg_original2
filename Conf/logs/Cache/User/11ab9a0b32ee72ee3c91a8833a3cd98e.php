...
<<<<<<< HEAD
            ...
            <td>
            <?php if($set["time"] != null ): ?><input class="Wdate" id="starttime" name="limittime" value="<?php echo (date("Y-m-d",$set["time"])); ?>" type="text" onClick="WdatePicker()" style="width:190px">     
              <?php else: ?>
                <input class="Wdate" id="starttime" name="limittime" value="" type="text" onClick="WdatePicker()" style="width:190px"><?php endif; ?>
...
=======
            <td>
              <input class="Wdate" id="starttime" name="limittime" value="<?php echo ($set["timeNum"]); ?>" type="text" onClick="WdatePicker()" style="width:190px">
            </td>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
          </tr>
...
=======
              <input type="text" name="timeNums" class="px" id="default_time" style="width:120px;" value="<?php echo ($set["time"]); ?>"/>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
            </td>
          </tr>
          <style>
...
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
          ...
          <td>
            ...
            &nbsp;
<<<<<<< HEAD
            <a href="<?php echo U('Shop/schedule',array('token'=>$token,'sid'=>$_GET['sid']));?>" class="btnGray vm">取消</a>
=======
            <a href="<?php echo U('Shop/departList',array('token'=>$token));?>" class="btnGray vm">取消</a>
>>>>>>> 01e200e4f8a1295bfce0a15384da812e38d13ba2
          </td>
        </tbody>
      </table>
