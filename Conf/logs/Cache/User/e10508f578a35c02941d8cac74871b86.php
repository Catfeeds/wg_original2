      ...
      <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
          ...
          <tr>
            ...
            <th>添加时间:</th>
            <td>
  <!--             <input name="endtime" value="<?php echo (date('Y-m-d',$list["addtime"])); ?>" type="text" style="width:190px"/> -->

              <p><?php echo (date('Y-m-d',$list["addtime"])); ?></p>
            </td>
          </tr>
          ...
          <tr>
            <th>用户：</th>
            <td>
  <!--             <input name="price" class="px" id="default_time" value ="<?php echo ($list["aid"]); ?>"style="width:120px;"/> -->
              <p><?php echo ($list["aid"]); ?></p>
            </td>
          </tr>
...
&nbsp; -->
            <a href="<?php echo U('Store/message',array('token'=>$token,'sid'=>$_SESSION['sid']));?>" class="btnGray vm">确认</a>
          </td>
        </tbody>
      </table>
    </div>
