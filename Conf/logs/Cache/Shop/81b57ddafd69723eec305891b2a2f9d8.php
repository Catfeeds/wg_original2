...
<!-- <td><?php echo ($hostlist["norms"]); ?>
<?php if(empty($hostlist['norms']) != true): ?><span>&nbsp;&nbsp;<a href="<?php echo U('Store/norms', array('catid'=>$hostlist['id'],'token'=>$token, 'type' => 0));?>">规格的管理</a></span><?php endif; ?>
</td> 
 -->

<!-- <td><?php echo ($hostlist["color"]); ?>
<?php if(empty($hostlist['color']) != true): ?><span>&nbsp;&nbsp;<a href="<?php echo U('Store/norms', array('catid'=>$hostlist['id'],'token'=>$token, 'type' => 1));?>">外观的管理</a></span><?php endif; ?>
</td> -->


<td><?php echo ($hostlist["sort"]); ?></td>
<!-- <td><?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?></td>  -->
<td><?php echo ($hostlist["pref"]); ?></td>
<td class="norightborder">
	...
	<?php if(($hostlist['isfinal']) != "2"): ?><span>&nbsp;|&nbsp;<a href="<?php echo U('Store/product',array('catid' => $hostlist['id'],'token'=>$_GET['token'],'parentid' => $hostlist['parentid']));?>" style="color:#f00">商品管理</a></span><?php endif; ?>
</td>
