...
<option value="0" <?php if(($_REQUEST['paid']) == "0"): ?>selected<?php endif; ?>>待付款</option><option value="1" <?php if(($_REQUEST['paid']) == "1"): ?>selected<?php endif; ?>>已付款</option></select>
...
<option value="">=请选择=</option>
<option value="0" <?php if(($_REQUEST['handled']) == "0"): ?>selected<?php endif; ?>>待处理</option><option value="1" <?php if(($_REQUEST['handled']) == "1"): ?>selected<?php endif; ?>>已处理</option></select>
