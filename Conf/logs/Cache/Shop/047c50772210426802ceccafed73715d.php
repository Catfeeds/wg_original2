...
<div class="welcome">欢迎使用多用户微信营销服务平台!111</div>
    <div class="memberinfo"  id="destoon_member">	
		<?php if($_SESSION['sid']==false): ?><a href="<?php echo U('Index/shoplogin');?>">登录</a>&nbsp;&nbsp;|&nbsp;&nbsp;
			...
			<?php else: ?>
			<a href="<?php echo U('Index/index');?>">>>我的公众号</a>&nbsp;你好,<a href="/#" hidefocus="true"  ><span style="color:red"><?php echo (session('shopname')); ?></span></a>（sid:<?php echo (session('sid')); ?>）
...
<?php
 $menus=array( array( 'name'=>'分店管理', 'iconName'=>'retail', 'display'=>0, 'subs'=>array( array('name'=>'附加时间限制','link'=>U('Retail/departset',array('token'=>$token)),'new'=>0,'selectedCondition'=>array('m'=>'Retail')), array('name'=>'微信商城系统','link'=>U('Store/index',array('token'=>$token)),'new'=>0,'selectedCondition'=>array('m'=>'Store')), )), ); ?>
<?php
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
	  ...
	  <?php if($parentid > 0): ?><tr> 
       ...
       <tr> 
        ...
        <td><input type="text" name="name" value="<?php echo ($set["name"]); ?>" class="px" style="width:100px;" /></td> 
       </tr> 
<!--        <tr> 
 <th>Logo地址：</th> 
...
<!--        <tr> 
 ...
 <td><input type="text" name="color" value="<?php echo ($set["color"]); ?>" id="color" class="px"/>(如：衣服一般有颜色,即填写【颜色】；酒水一般都是没有颜色的，没有外观可不填写)</td> 
     ...
     <tr> 
        <th>组合优惠价：</th> 
        <td><input type="text" id="sort" name="pref" value="<?php echo ($set["pref"]); ?>" class="px" style="width:50px;" />
        </td> 
       </tr>
