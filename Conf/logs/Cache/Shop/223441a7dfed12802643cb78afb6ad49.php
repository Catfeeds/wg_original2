...
<script language="javascript" type="text/javascript" src="<?php echo RES;?>/js/jquery-1.11.1.min.js"></script>
<div class="content">
  <div class="cLineB">
    <h4>附加时间限制</h4>
  </div>
      ...
      <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          ...
          <tr>
            <th>时间选择:</th>
            <td>
              <input class="Wdate" id="starttime" name="limittime" value = "
              <?php
 if($set['time']){ echo date("Y-m-d",$set['time']); }else{ echo date("Y-m-d",time()); } ?>
              "
              type="text" 
              onClick="WdatePicker()" style="width:190px">
            </td>
          </tr>
          ...
          <tr>
            <th>设置预约个数：</th>
            <td>
              <input type="text" name="timeNums" class="px" id="default_time" style="width:120px;" value="<?php echo ($set["timeNum"]); ?>"/>
            </td>
          </tr>
          <style>
         .w15{
         ...
         for (var i = 0; i < 5; i++) {
          ...
          <td>
            ...
            &nbsp;
            <a href="<?php echo U('Retail/schedule',array('token'=>$token,'sid'=>$_SESSION['sid']));?>" class="btnGray vm">取消</a>
          </td>
        </tbody>
      </table>
    </div>
